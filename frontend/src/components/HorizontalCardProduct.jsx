                ...
                >
                  ...
                  <div className="p-4 grid w-full gap-2">
                    ...
                    <div className="flex gap-3 w-full">
                      <p className="text-red-600 font-semibold p-1  bg-slate-200 w-full animate-pulse rounded-full"></p>
                      <p className="text-slate-500 line-through p-1  bg-slate-200 w-full animate-pulse rounded-full"></p>
                    </div>
                    <button className="text-sm text-white px-3 py-1  w-full  bg-slate-200 animate-pulse rounded-full"></button>
                  </div>
                </div>
              );
            })
