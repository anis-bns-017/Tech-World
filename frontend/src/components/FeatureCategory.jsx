    ...
    <div>
      <div>
        <div className="items-center justify-center text-center mt-10">
          ...
          <p className="mt-3">Get Your Desired Product from Featured Category!</p>
        </div>
      </div>
      <div>
        <div className="flex flex-wrap m-12">
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3 flex items-center justify-center text-center">
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="hover:text-red-500 cursor-pointer">Laptop Accessories</p>
            </div>
          </div>
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              <img height={50} width={50} src={mobile} alt="" />
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="hover:text-red-500 cursor-pointer">Mobile Accessories</p>
            </div>
          </div>
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              <img height={50} width={50} src={powerBank} alt="" />
              <p className="hover:text-red-500 cursor-pointer">Portable Power Station</p>
            </div>
          </div>
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="hover:text-red-500 cursor-pointer">VR (Virtual Reality)</p>
            </div>
          </div>
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="hover:text-red-500 cursor-pointer">Bluetooth Speakers</p>
            </div>
          </div>
          ...
          <div className="w-[150px] h-[130px] max-h-[160px] rounded-[15px] bg-white m-1 my-3  flex items-center justify-center text-center">
            <div className="flex flex-col items-center">
              ...
              <p className="hover:text-red-500 cursor-pointer">Gaming Console</p>
            </div>
          </div>
        </div>
      </div>
